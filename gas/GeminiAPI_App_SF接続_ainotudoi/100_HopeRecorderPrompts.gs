...
function dump_HopeRecorderConfig() {
  ...
  Logger.log(
    "batch.maxOutputTokens: " + HOPE_RECORDER_ACTIVE.batch.maxOutputTokens,
  );
  Logger.log(
    "batch.speechConfig: " +
      JSON.stringify(HOPE_RECORDER_ACTIVE.batch.speechConfig),
  );
  Logger.log("cleaning.model: " + HOPE_RECORDER_ACTIVE.cleaning.model);
  Logger.log(
    "cleaning.temperature: " + HOPE_RECORDER_ACTIVE.cleaning.temperature,
  );
  Logger.log(
    "batch.prompt length: " + HOPE_RECORDER_ACTIVE.batch.prompt.length,
  );
  Logger.log(
    "cleaning.promptSystem length: " +
      HOPE_RECORDER_ACTIVE.cleaning.promptSystem.length,
  );
}
